    ...
    <div id="dashboard-widgets-wrap">
         <div id="dashboard-widgets" class="metabox-holder">
             <div class="postbox-container" style="width:99%">
                  ...
                  <div class="corner-all server-settings">
                        ...
                        <br class="clear"/>
                        <div class="settings-separator">&nbsp;</div>
                        <div class="settings-label">Reports to use Slave DB</div>
                        <div class="settings-value"><?=form_dropdown('reports_use_slave_db[]',$slavedb,explode(",",$settings[0]->reports_use_slave_db),'multiple id="reports_use_slave_db[]"')?></div>
                        <br class="clear"/>
                        <div class="settings-separator">&nbsp;</div>
