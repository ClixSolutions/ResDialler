        ...
        <thead>
            <tr class="user-hdr">
               ...
               <th class="user-tbl-cols user-tbl-cols-centered search-tbl-defleted">
                   ...
                   <div class="user-cols-action-lbl"><span>&nbsp;&nbsp;ACTION&nbsp;<?=img("img/arrow_down.png")?></span></div>
               </th>              
            </tr>
        </thead>
        <tbody>
        <?Php
             ...
             foreach($users as $usersInfo){
                      ...
                      echo "<tr id='$usersInfo->lead_id' class='user-tbl-rows ".(($ctr%2==0)?'user-odd':'user-even')."'>";
                           ...
                           echo "<td class='user-tbl-cols search-tbl-name'>".((strlen($usersInfo->disposition) > 26)?substr($usersInfo->disposition,0,23)."...":$usersInfo->disposition)."</td>";
