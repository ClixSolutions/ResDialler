...
<!-- DASHBOARD MENU -->
	...
	<li class="wp-has-submenu <? echo $rec; ?> menu-top menu-icon-recordings" id="menu-links" title="Recordings">
	...
	<li class="wp-has-submenu <? //echo $sup; ?> open-if-no-js menu-top menu-top-last menu-icon-support toolTip" title="Support" id="menu-support">
