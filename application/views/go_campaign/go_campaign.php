...
#overlayLeadRecycle,#overlayPauseCodes,#overlayHotKeys{
	background:transparent url(<?php echo $base; ?>img/images/go_list/overlay.png) repeat top left;
	position:fixed;
	top:0px;
	bottom:0px;
...
#statusBox,#fileBox,#hopperBox,#boxStatus,#boxLeadRecycle,#boxPauseCodes,#boxHotKeys{
	position:absolute;
	top:-2550px;
	left:30%;
	right:30%;
...
#closeboxLeadRecycle, #closeboxPauseCodes, #closeboxHotKeys {
	float:right;
	width:26px;
	height:26px;
...
.go_hotkeys_submenu, .go_camp_hotkeys_submenu {
...
$(function()
{
	...
	$('li.go_action_submenu,li.go_status_submenu,li.go_camp_status_submenu,li.go_lead_recycle_submenu,li.go_camp_lead_recycle_submenu,li.go_pausecodes_submenu,li.go_camp_pausecodes_submenu,li.go_hotkeys_submenu,li.go_camp_hotkeys_submenu').hover(function()
	{
	...
	$('#add_status').click(function()
	{
		if (camp_create!='N')
		{
			...
			$('#boxStatus').css({'width': '700px','margin-left': 'auto', 'margin-right': 'auto', 'left': '14%', 'right': '14%', 'padding-bottom': '10px', 'position': 'fixed'});
			$('#boxStatus').animate({
				top: "70px"
			}, 500);
		} else {
