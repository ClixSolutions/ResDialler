...
$wwwroot='/var/www/html/application/views';
$realabsolute = str_replace($wwwroot, '', '/application/views'.$wwwabsolute);
$realabsolute = $realabsolute.'/';
$webpath = "$realabsolute";

//$webpath= 'http://'.$_SERVER['HTTP_HOST'].'/application/views/phpsysinfo/'; 

//echo $webpath;
// define the default lng and template here
$default_lng='en';
$default_template='bulix';
