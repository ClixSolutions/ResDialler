...
<table id="test" border=0 cellpadding="3" cellspacing="3" style="width:95%; color:#000; margin-left:auto; margin-right:auto;">
	...
	<tr>
    	<td style="text-align:right;" nowrap>Dial Plan Number:</td><td><?=form_input('dialplan_number',$phone_info->dialplan_number,'size="20" maxlength="15"') ?></td>
    </tr>
	<tr>
	...
	<tr>
    	<td style="text-align:right;" nowrap>Client Protocol:</td><td>
			<?php
			$protocolArray = array('SIP'=>'SIP','Zap'=>'Zap','IAX2'=>'IAX2','EXTERNAL'=>'EXTERNAL');
