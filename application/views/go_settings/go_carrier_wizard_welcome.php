...
.sales-email{float:right;text-align:left;font-size:9px;margin-top:25px;}
	...
	<tr>
		...
		<td valign="top" >
                       <div class="welcome-header">
                          <span>Welcome to</span><br class="clear"/>
                          <span><a href="http://justgovoip.com" target="_new"><img src="<?=$base?>img/justgovoip.png"></a></span><br class="clear"/>
                          <span>VoIP services powered<br class="clear"/>by GoAutoDial</span><br/>
                          <br/>
                          <span>
                                Tired of getting your dialer traffic rejected<br/>
                                all the time? Tired of switching from one <br/>
                                carrier to another? We're here for you.<br/>
                                Our VoIP service is designed for high<br/>
                                volume call center traffic. Whether you're<br/>
                                running 5 seats or 500+, we will connect <br/>
                                your calls. No more congestions and<br/>
                                headaches. <br/><br/>
 
                                Signing up and using our VoIP service<br/>
                                directly supports the development of<br/>
                                the GoAutoDial open source<br/>
                                project (this system that you're currently using).
                          </span><br /><br/>
                          <br/>
                          <span class="signup60"><img src="<?=$base?>img/signup60free.png"></span><br/>
                          <span class="sales-email">**email sales@justgovoip.com to get 60 free minutes (US, UK and Canada calls only).</span><br/>
                       </div>
		</td>
	</tr>
</table>
