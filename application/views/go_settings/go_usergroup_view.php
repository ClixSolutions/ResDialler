...
<table id="test" border=0 cellpadding="3" cellspacing="3" style="width:98%; color:#000; margin-left:auto; margin-right:auto;">
	...
	<tr class="advance_settings" style="display: none;">
		...
		echo form_dropdown('allowed_reports[]',$UGreportsList,$UGreportsSelected,'size="8" class="modify-usergroup"');
		?>
		</td>
	</tr>
	<tr class="advance_settings" style="display: none;">
	...
	<tr class="advance_settings" style="display: none;">
		...
		if (preg_match("/---ALL---/",$group_info->admin_viewable_call_times))
			$checked = TRUE;
			echo form_checkbox('admin_viewable_groups[]',"---ALL---", $checked,' class="modify-usergroup"' )." <b>ALL-CALLTIMES</b> - All call times in the system<br />\n";
