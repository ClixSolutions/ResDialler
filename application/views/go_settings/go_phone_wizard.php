		...
		<input type="hidden" name="old_messages_<?=$key?>" value="0" />
                <table id="phoneTable" style="width:100%;">
                    <tr>
                        ...
                        <td>
                        <?=form_input('extension_'.$key,$gens["extension_$key"],'id="extension_'.$key.'" maxlength="20" size="25"') ?>&nbsp;
                    ...
                    <tr>
						...
						echo form_dropdown('user_group_'.$key,$groupArray,null,'id="user_group_'.$key.'"');
						?>
                        </td>
                    </tr>
                    <tr style="display:none;">
						...
						echo form_dropdown('server_ip_'.$key,$serverArray,null,'id="server_ip_'.$key.'"');
						?>
                        </td>
                    </tr>
                    ...
                    ?>
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;<?php echo $display?>">
                        <label class="modify-value">Server:</label>
                        </td>
                        <td>
                        <?=form_dropdown('server_ip_'.$key,$servers,'id="server_ip_'.$key.'" maxlength="50" size="20"') ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;">
