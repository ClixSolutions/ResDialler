...
class Go_index extends Controller {
	...
	function go_vtiger()
	{
		$data['go_main_content'] = 'go_vtigercrm';
...
function closebrowser()
	...
	function agplv2(){
		...
		$data['folded'] = 'folded';
		$data['bannertitle'] = 'GNU Affero General Public License - Version 2';
		$data['userfulname'] = $callfunc;
                $data['hideinfo'] = "yes";
		$data['adminheaderlink'] = 1;
		$data['logo'] = "goadmin_logo.png";
		$data['title'] = "GoAutoDial - Empowering the Next Generation Contact Centers";		
		$this->load->view('includes/go_dashboard_template', $data);
        }
	...
	function gplv2(){
		...
		$data['folded'] = 'folded';
		$data['bannertitle'] = 'GNU General Public License - Version 2';
		$data['userfulname'] = $callfunc;
                $data['hideinfo'] = "yes";
		$data['adminheaderlink'] = 1;
		$data['logo'] = "smalllogo.png";
