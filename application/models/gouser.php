...
class Gouser extends Model {
     ...
     function collectusers($account=null){
          ...
          if(!is_null($account)){
              ...
              //}
              $this->asteriskDB->where("vicidial_users.user !=","VDAD");
              $this->asteriskDB->where("vicidial_users.user !=","VDCL");
              $this->asteriskDB->where("vicidial_users.user_level <=",$this->session->userdata("users_level"));
              $this->asteriskDB->where("vicidial_users.full_name NOT LIKE","%Survey%");
              $this->asteriskDB->order_by('vicidial_users.user','asc');
