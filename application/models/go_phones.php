...
class Go_phones extends Model {
	...
	function go_get_phone_list()
	{
		$query = $this->db->query("SELECT extension,protocol,server_ip,dialplan_number,voicemail_id,status,active,fullname,messages,old_messages,user_group FROM phones ORDER BY extension;");
		$return = $query->result();
