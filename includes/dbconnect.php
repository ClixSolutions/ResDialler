...
if (isset($_GET['gouser']) && isset($_GET['gopass']))
	{
	$gouser = $_GET['gouser'];
	$gopass = $_GET['gopass'];
	$_SESSION['gouser'] = $gouser;
	$_SESSION['gopass'] = $gopass;
	$_SERVER['PHP_AUTH_USER'] = $gouser;
	$_SERVER['PHP_AUTH_PW'] = $gopass;
	}
else
	{
	if (isset($_SESSION['gouser']) && isset($_SESSION['gopass']))
		{
		$gouser = $_SESSION['gouser'];
		$gopass = $_SESSION['gopass'];
		$_SERVER['PHP_AUTH_USER'] = $gouser;
		$_SERVER['PHP_AUTH_PW'] = $gopass;
		}
	}
